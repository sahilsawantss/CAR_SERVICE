...
$result = mysqli_query($conn, "SELECT * FROM service ORDER BY id DESC");//using mysqli_query instead
...
<body>
	...
	<h1><center>View Service</center></h1><hr />
	<table width="80%" border="2" align="center">
	   <tr bgcolor="#000000">
	       <td style="color:#CCCCCC; font-weight:bold">Service Name</td>
		   <td style="color:#CCCCCC; font-weight:bold">Service Description</td>
		   <td style="color:#CCCCCC; font-weight:bold">Service Cost (₹)</td>
		...
		<?php
		   while($res=mysqli_fetch_array($result)) {
			   ...
			   echo"<td>".$res['cost']."</td>";
			   echo"<td><a href=\"serviceedit.php?id=$res[id]\">Edit</a>|
			   <a href=\"servicedelete.php?id=$res[id]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
			   }
			   ?>
			   </table>
<br />
